          ...
          <div className="bg-background border border-foreground/10 p-8 md:p-10">
            ...
            <div className="flex items-start gap-4 pb-6 border-b border-foreground/10">
              ...
              <div className="flex-1">
                ...
                <p className="font-heading font-bold text-foreground leading-tight">VAPESPORT VLACH s.r.o.</p>
                ...
                <p className="text-sm text-foreground/70 mt-2">IČO: 05819369 · DIČ: CZ05819369</p>
                <p className="text-sm text-foreground/70">Spis. zn. C 69479, Krajský soud v Ostravě</p>
                <a
                  href={vcfHref}
